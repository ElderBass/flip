...
const decks = [
  ...
  // },
  {
    deckName: "Ballads",
    cards: [
      { front: "The Last Wish", back: "Love story between Yen and Geralt", id: uuidv4() },
      {
      ...
      { front: "The Edge of the World", back: "Where Geralt and I travel to the bounds of the earth and uncover the mischief of a sylvan", id: uuidv4() },
    ],
    favorites: 5,
    userId: dandelionId,
    author: "dandy_lion",
